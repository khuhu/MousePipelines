...
### 20240205 something was wrong with names i.e spaces making the script mess up and not create files
### made column Sample.Name2 without the spaces
...
#                  "-r /home/reference/mm39/mm39.fa -N 10")
#     system(eval(cmd))
#   }
# }
