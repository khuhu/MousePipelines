...
ampSeg <- function(mouseAmplicons, mouseBedFile, outDir, minAmp){ 
  ...
  # load("/mnt/DATA5/tmp/kev/misc/20230426lqAmpsAll.RData")
  # badAmpIdx <- lqAmpsAllZ$idNum
  # mouseBed2 <- mouseBed2[-badAmpIdx,]
  # mouseAmplicons2 <- mouseAmplicons2[-badAmpIdx,]
  ...
  segResults <- foreach(i=allMouseCalls,
                        .combine = 'rbind', .packages = c('DNAcopy')) %dopar% {
                          ...
                          segment_tmpCNA <- segment(smoothed_tmpCNA, verbose = 1, undo.splits = "sdundo",
                                                    p.method = c("hybrid"), undo.SD = 3, min.width = minAmp)
...
# opt$bed <- "/mnt/DATA6/mouseData/copynumber/Auto_user_AUS5-114-PGU2_NL20001_324_287/bed.txt"
# opt$amplicon <- "/mnt/DATA6/mouseData/copynumber/Auto_user_AUS5-114-PGU2_NL20001_324_287/cnAmplicon_matrix.txt"
# opt$gc <- "/mnt/DATA6/mouseData/copynumber/Auto_user_AUS5-114-PGU2_NL20001_324_287/gcCorrectedCounts_matrix.txt"
# opt$normal <- "/mnt/DATA6/mouseData/copynumber/Auto_user_AUS5-114-PGU2_NL20001_324_287/normals.txt"
# opt$out <- "/mnt/DATA6/mouseData/copynumber/Auto_user_AUS5-114-PGU2_NL20001_324_287/"
# opt$param <- "/mnt/DATA6/mouseData/copynumber/Auto_user_AUS5-114-PGU2_NL20001_324_287/param.txt"
...
paramFile <- read.table(opt$param, sep = " ")
...
for (i in unique(segZfilt$ID)) {
  ...
  g1 <- freqPlot_cn(testDf_cn, main = paste(i), chromTextSpec = paramFile$V2)
  grob1 <- ggplotGrob(g1)
